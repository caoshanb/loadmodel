							...
							<form id="timeSocl" class="timeSocl" name="newProject" >
								<div class="mout">
									...
									<div>
										<label>发布时间：</label>
										<span class="timeSel">
								            <input type="text" autocomplete="off" id="J-x6" value="" readonly="readonly"  required  name="s" ng-blur="s=true" ng-model="newSystems.pjtime_release"  placeholder="请选择"/  ><i class="icon iconfont icon-riqi1 iconfontss"></i>
